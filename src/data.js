export const SCHOLARSHIPS = [
  {
    ...
    eligibilityCriteria: {
      gpaMin: 5.0, // GPA out of 10 or pass marks
      incomeMax: 250000, // Rs 2.5 Lakhs
      firstGenRequired: false,
      stateResidency: null, // National
  ...
  },
  {
    ...
    eligibilityCriteria: {
      gpaMin: 6.0,
      incomeMax: 800000, // Rs 8 Lakhs (EWS threshold)
      firstGenRequired: false,
      stateResidency: null,
  ...
  },
  {
    ...
    eligibilityCriteria: {
      gpaMin: 6.0, // 60% equivalent
      incomeMax: 600000, // Rs 6 Lakhs
  ...
  },
  {
    ...
    eligibilityCriteria: {
      gpaMin: 8.5, // 85% in Board Exams
      incomeMax: 600000,
      firstGenRequired: false,
      stateResidency: ["MH", "KA", "DL", "TN"], // Maharashtra, Karnataka, Delhi, Tamil Nadu
...
export const GLOSSARY = [
  {
    ...
    definition: "An official certificate verifying your family's annual income. It is issued by the Tehsildar (a local government revenue officer) at the Taluka office. Self-declaration, salary slips, or private affidavits are not accepted for major government scholarships."
  },
  {
    term: "Bonafide Student Certificate",
    definition: "A document issued by the college Principal, Director, or Registrar certifying that you are a regular, full-time student of that institution. It must contain the college's official letterhead, round seal, and signing authority's stamp."
  },
  {
    term: "Domicile Certificate",
    definition: "A residency document issued by state authorities (typically Revenue Department) certifying that you have lived in that specific Indian state for a set number of years (often 10-15 years). Many state scholarships require this."
  },
  {
    term: "NSP",
    definition: "National Scholarship Portal (Govt of India). A single digital portal that hosts hundreds of scholarships offered by Central ministries (like Minority Affairs, Social Justice) and State governments."
  },
  {
    term: "Aadhaar Seeding",
    definition: "Linking your Aadhaar card number to your active bank account. The government uses Aadhaar seeding to send scholarship money directly to your account using Direct Benefit Transfer (DBT), preventing leakages."
  },
  {
    term: "EWS",
    definition: "Economically Weaker Section. An income-based category in India. Families with annual income below ₹8 Lakhs who do not belong to SC, ST, or OBC are classified as EWS and qualify for specific merit/need scholarships."
  },
  {
    term: "Caste Certificate",
    definition: "An official certificate issued by state revenue offices declaring that you belong to a scheduled caste (SC), scheduled tribe (ST), or other backward class (OBC). Highly important for reservation and caste-based fellowships."
  },
  {
    term: "Admission Letter",
    definition: "An official seat allotment letter issued by the college or the state entrance cell (e.g. DTE, CET) confirming your branch, registration roll number, and admission quotas."
  }
];

export const FAQ = [
  {
    q: "What does it mean to be a 'first-generation' college student in India?",
    a: "In India, you are a first-generation student if neither of your parents went to college or completed a degree. If your parents only attended school up to Class 10 or 12, you are a first-gen student! Having elder siblings in college does not affect your first-gen status."
  },
  {
    q: "How can I apply for an Income Certificate?",
    a: "You can apply online through your state's digital services portal (e.g., Mahaonline/MahaDBT in Maharashtra, Seva Sindhu in Karnataka, e-District in UP/Delhi) or visit a local CSC (Common Service Centre) / Maha e-Seva Kendra. You will need land records, a ration card, an Aadhaar card, and self-declarations."
  },
  {
    q: "Is an income certificate from my parents' office valid for NSP?",
    a: "Generally, no. Government portals like NSP or state DBTs strictly require a certificate issued by a Revenue Authority (not below the rank of Tehsildar/Naib Tehsildar). Private salary slips are only accepted for private corporate scholarships (like Kotak or HDFC)."
  },
  {
    q: "What is Aadhaar-enabled Direct Benefit Transfer (DBT)?",
    a: "It is a government system where scholarship money is directly deposited into your bank account. For this to work, you must link your Aadhaar number to your bank account (Aadhaar Seeding) and ensure your bank account is active (KYC completed)."
  }
];
...
export const MOCK_MENTOR_CHAT = [
  {
    sender: "mentor",
    time: "2026-06-25T10:15:00Z",
    text: "Namaste! I am Sarah, your College & Scholarship Mentor. I am here to help you get your certificates, write essays, or navigate government portals like NSP. How is your application process going?"
  },
  {
    sender: "student",
    time: "2026-06-25T14:30:00Z",
    text: "Hello ma'am! I am preparing my application for the HDFC Badhte Kadam Scholarship, but I don't have a Tehsildar income certificate yet."
  },
  {
    sender: "mentor",
    time: "2026-06-25T14:35:00Z",
